...
\begin{center}
  % NAME
  {\Huge\scshape Curriculum Vitae/Resume}
  % SUBHEADING
  \\ Ajay Ganesh - SUGS CSE - UMID: 09453051\\
  \small
  % EMAIL
...
\resumeItem{\textbf{Honors:} University Honors (x5), Dean's List (x5), James B. Angell Scholar}
\resumeItemListEnd
...
\resumeItem{Optimized code for a Rust web API handling authorization and billing for Deepgram’s automatic speech recognition models, resulting in a 5 ms average decrease in response time and greater standardization of error messages}
